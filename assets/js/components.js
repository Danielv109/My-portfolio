    ...
    return `
      <div class="container">
        ...
        <div class="about-content">
          <p><strong>Focus:</strong> Specialized in firewalls (Fortinet/Palo Alto), SD-WAN, SSL/TLS, IPS/IDS, and SIEM/SOAR implementations.</p>
          <p><strong>Strength:</strong> Expert troubleshooting and incident response in complex network environments.</p>
          <p><strong>Context:</strong> Computer Systems Engineering student with deep interest in banking and regulated environments.</p>
          <p><strong>Availability:</strong> Open to full-time or internship opportunities; remote/hybrid/on-site.</p>
        </div>
      </div>
    `;
  },
      ...
      <div class="project-card" data-project="${project.id}">
        ...
        <div class="project-details">
          <div class="project-section">
            <h4>Architecture</h4>
            <img src="${project.diagram}" alt="${project.title} Architecture" class="architecture-diagram" loading="lazy">
          </div>
    ...
    return `
      <div class="container">
        ...
        <div class="compliance-grid">
          ${this.createComplianceChecklist()}
